...
@app.command("run")
def run(
    application_id: UUID = typer.Option(..., "--application-id", help="Application UUID to reconcile"),
    ...
    typer.echo(f"Reconciliation completed for application {result.get('application_id')}")
